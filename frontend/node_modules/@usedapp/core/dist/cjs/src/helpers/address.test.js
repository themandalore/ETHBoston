...
describe('addressHelper', () => {
    describe('shortenAddress', () => {
        ...
        it('wrong address', () => {
            ...
            (0, chai_1.expect)(() => (0, address_1.shortenAddress)(address)).to.throw("Invalid input, address can't be parsed");
        });
    });
    ...
    describe('addressCompare', () => {
        ...
        it("can't parse address", () => {
            ...
            (0, chai_1.expect)(() => (0, address_1.compareAddress)(address1, address2)).to.throw("Invalid input, address can't be parsed");
        });
    });
    describe('addressEqual', () => {
        ...
        it('not an address', () => {
            ...
            (0, chai_1.expect)(() => (0, address_1.addressEqual)(address1, address2)).to.throw("Invalid input, address can't be parsed");
        });
    });
});

...
function useRawCalls(calls) {
    const { dispatchCalls, chains } = (0, react_1.useContext)(providers_1.MultiChainStatesContext);
    (0, react_1.useEffect)(() => {
...
function extractCallResult(chains, call) {
    ...
    if (chainId !== undefined) {
        ...
        if (error) {
            ...
            const value = new ethers_1.utils.Interface(['function Error(string)']).encodeFunctionData('Error', [errorMessage]);
            return {
                success: false,
                value,
            };

...
describe('useSendTransaction', () => {
    ...
    it('success', async () => {
        ...
        (0, chai_1.expect)(deployerBalanceAfterTransaction).to.eq(deployerBalanceBeforeTransaction.sub(10).sub(txFee !== null && txFee !== void 0 ? txFee : 0));
        (0, chai_1.expect)(wallet1BalanceAfterTransaction).to.eq(wallet1BalanceBeforeTransaction.add(10));
    });
    ...
    it('Can send transaction with mnemonic phrase', async () => {
        ...
        (0, chai_1.expect)(wallet1BalanceAfterTransaction).to.eq(wallet1BalanceBeforeTransaction.sub(10).sub(txFee !== null && txFee !== void 0 ? txFee : 0));
        (0, chai_1.expect)(wallet2BalanceAfterTransaction).to.eq(wallet2BalanceBeforeTransaction.add(10));
        (0, chai_1.expect)(result.current.state.receipt).to.not.be.undefined;

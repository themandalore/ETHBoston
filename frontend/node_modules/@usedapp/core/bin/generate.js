    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            Object.keys(factories).forEach(function (factoryName) {
                ...
                //write events
                Object.keys(Interface.events).forEach(function (event) {
                    var eventName = event.split('(')[0];
                    output += "\nexport const use".concat(contractName, "_event_").concat(eventName, " = (\n  contractAddress: Falsy | string,\n  args: Falsy | TypedFilter<").concat(contractName, ", '").concat(eventName, "'>['args'],\n  queryParams: QueryParams = {}\n) => {\n  return useLogs(\n    contractAddress\n      && {\n        contract: new Contract(contractAddress, ").concat(contractName, "Interface),\n        event: '").concat(eventName, "',\n        args: args || [],\n      },\n    queryParams\n  )\n}\n\n");
                });
                output += "\nexport const use".concat(contractName, " = {\n  ").concat(Object.keys(Interface.functions)
                    ...
                    .join(",\n  "), ",\n  events: {\n  ").concat(Object.keys(Interface.events)
                    .map(function (event) { return event.split('(')[0]; })
                    .map(function (event) { return "  ".concat(event, ": use").concat(contractName, "_event_").concat(event); })
                    .join(",\n  "), "\n  }\n}\n");

import type { AnySchema, AnySchemaObject, AnyValidateFunction, EvaluatedProperties, EvaluatedItems } from "copy-webpack-plugin/node_modules/ajv/dist/types";
import type Ajv from "copy-webpack-plugin/node_modules/ajv/dist/core";
import type { InstanceOptions } from "copy-webpack-plugin/node_modules/ajv/dist/core";
import { CodeGen, Name, Code, ValueScopeName } from "copy-webpack-plugin/node_modules/ajv/dist/compile/codegen";
import { LocalRefs } from "copy-webpack-plugin/node_modules/ajv/dist/compile/resolve";
import { JSONType } from "copy-webpack-plugin/node_modules/ajv/dist/compile/rules";

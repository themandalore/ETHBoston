    ...
    runUpload(dataStream, transactionOpts) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            while (hasData) {
                ...
                const promise = (() => tslib_1.__awaiter(this, void 0, void 0, function* () { return yield promiseFactory(chunk, offset, ++chunkID); }))().then((value) => [promise, value]);
            ...
            const finalHeaders = Object.assign({ "Content-Type": "application/octet-stream" }, headers);
            if ((_c = transactionOpts === null || transactionOpts === void 0 ? void 0 : transactionOpts.upload) === null || _c === void 0 ? void 0 : _c.paidBy)

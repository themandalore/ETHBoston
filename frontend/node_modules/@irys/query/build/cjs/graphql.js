...
class GraphQLQuery {
    ...
    buildQuery() {
        ...
        if (this.config.numResults && ((_c = this.queryInfo.paging) === null || _c === void 0 ? void 0 : _c.limiterName)) {
            vars[(_d = this.queryInfo.paging) === null || _d === void 0 ? void 0 : _d.limiterName] = Math.max(this.config.numResults, 1);
        }
        ...
        for (const [k, v] of Object.entries((_e = this.queryInfo.remapVars) !== null && _e !== void 0 ? _e : {})) {
        ...
        if (!((_f = this === null || this === void 0 ? void 0 : this.queryInfo) === null || _f === void 0 ? void 0 : _f.name))

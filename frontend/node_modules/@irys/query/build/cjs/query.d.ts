import { GraphQLQuery } from "@irys/query/build/cjs/graphql";
import type { ArweaveBlocks, ArweaveBlocksVars } from "@irys/query/build/cjs/queries/arweave/blocks";
import type { ArweaveTransactions, ArweaveTransactionsVars } from "@irys/query/build/cjs/queries/arweave/transactions";
import type { IrysTransactionVars, IrysTransactions } from "@irys/query/build/cjs/queries/irys/transactions";
import type { BuilderMethods, QueryCtorOpts, SearchOpts } from "@irys/query/build/cjs/types";
